...
<template #id>
   <el-table-column
    ...
    <template #operate="scope">
      <el-button size="mini" type="primary" @click="$router.push(`/class/edit/${scope.row._id}`)">编辑</el-button>
...
<script>
import { getfetchList } from '@/api/classs'
  ...
  setup() {
    const state = reactive({
      ...
      async getList(params) {
        ...
        const { type, content } = await getfetchList(params)
